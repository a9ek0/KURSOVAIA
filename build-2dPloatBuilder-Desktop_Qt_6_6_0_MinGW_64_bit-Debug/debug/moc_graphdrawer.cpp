/****************************************************************************
** Meta object code from reading C++ file 'graphdrawer.h'
**
...
#include "../../2dPloatBuilder/graphdrawer.h"
...
#error "The header file 'graphdrawer.h' doesn't include <QObject>."
...
static constexpr auto qt_meta_stringdata_CLASSGraphDrawerENDCLASS = QtMocHelpers::stringData(
    "GraphDrawer",
    "slotAlarmTimer",
    ""
);
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSGraphDrawerENDCLASS_t qt_meta_stringdata_CLASSGraphDrawerENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(12, 14),  // "slotAlarmTimer"
        QT_MOC_LITERAL(27, 0)   // ""
    },
    "GraphDrawer",
    "slotAlarmTimer",
